        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1 w-full flex flex-col gap-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-background border border-stone-300/50 p-8 rounded-[2.5rem] shadow-[0_2px_15px_-5px_rgba(0,0,0,0.03)] flex flex-col gap-4">
                ...
                <div className="flex items-end justify-between">
                  ...
                  <Link href="/orders" className="text-[11px] font-bold uppercase tracking-widest text-foreground border-b border-stone-900/20 pb-0.5 hover:border-stone-900 transition-all">View All</Link>
                </div>
              </div>
              <div className="bg-background border border-stone-300/50 p-8 rounded-2xl shadow-[0_2px_15px_-5px_rgba(0,0,0,0.03)] flex flex-col gap-4">
                <p className="text-[12px] font-bold uppercase tracking-[0.3em] text-stone-600">Wishlist Items</p>
                <div className="flex items-end justify-between">
                  <span className="text-3xl font-serif text-foreground">{wishlistCount}</span>
                  <Link href="/wishlist" className="text-[11px] font-bold uppercase tracking-widest text-foreground border-b border-stone-900/20 pb-0.5 hover:border-stone-900 transition-all">Explore</Link>
                </div>
              </div>
              <div className="bg-background border border-stone-300/50 p-8 rounded-2xl shadow-[0_2px_15px_-5px_rgba(0,0,0,0.03)] flex flex-col gap-4">
                <p className="text-[12px] font-bold uppercase tracking-[0.3em] text-stone-600">Shopping Bag</p>
                <div className="flex items-end justify-between">
                  <span className="text-3xl font-serif text-foreground">{cartCount}</span>
                  <Link href="/cart" className="text-[11px] font-bold uppercase tracking-widest text-foreground border-b border-stone-900/20 pb-0.5 hover:border-stone-900 transition-all">Checkout</Link>
                </div>
              </div>
            </div>

            {/* Profile Section */}
            <section className="bg-background border border-stone-300/50 p-10 lg:p-12 rounded-[2.5rem] shadow-[0_2px_15px_-5px_rgba(0,0,0,0.03)] flex flex-col gap-12">
              <div className="flex justify-between items-center">
                ...
                {!isEditing && (
                  <button 
                    ...
                    className="px-6 py-2.5 bg-primary text-white text-[12px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-stone-800 transition-all hover:shadow-lg active:scale-95"
                  >
                    Edit Profile
                  </button>
                )}
              ...
              {isEditing ? (
                <form onSubmit={handleUpdateProfile} className="flex flex-col gap-10">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="flex flex-col gap-3">
                      ...
                      <input 
                        ...
                        className="text-base font-medium text-foreground border-b border-stone-200 pb-4 focus:outline-none focus:border-stone-900 transition-colors bg-transparent"
                  ...
                  <div className="flex items-center gap-4 pt-4">
                    <button 
                      ...
                      className="px-8 py-3 bg-primary text-white text-[12px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-stone-800 transition-all disabled:opacity-50 disabled:cursor-not-pallowed shadow-lg"
                    >
                    ...
                    <button 
                      ...
                      className="px-8 py-3 border border-stone-300 text-foreground text-[12px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-background-alt transition-all"
                    >
                      Cancel
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="flex flex-col gap-3">
                    <label className="text-[12px] font-bold uppercase tracking-[0.3em] text-stone-600">Full Name</label>
                    <p className="text-base font-medium text-foreground border-b border-stone-200 pb-4">{user?.name}</p>
                  </div>
                  <div className="flex flex-col gap-3">
                    <label className="text-[12px] font-bold uppercase tracking-[0.3em] text-stone-600">Email Address</label>
                    <p className="text-base font-medium text-foreground border-b border-stone-200 pb-4">{user?.email}</p>
                  </div>
                </div>
              )}
              
              <div className="pt-6">
                 <div className="bg-background-alt/50 rounded-2xl p-6 border border-stone-200/50 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex flex-col gap-1">
                      <p className="text-[13px] font-bold text-foreground uppercase tracking-widest">Two-Factor Authentication</p>
                      <p className="text-[13px] text-stone-600 font-medium">Add an extra layer of security to your account.</p>
                    </div>
                    <button className="text-[12px] font-bold uppercase tracking-[0.2em] text-foreground border border-stone-300 px-6 py-2.5 rounded-full hover:bg-background transition-all">
                      Enable 2FA
                    </button>
                 </div>
              </div>
            ...
            <section className="bg-[#1C1C1C] text-white p-10 lg:p-14 rounded-[2.5rem] shadow-2xl overflow-hidden relative group">
              ...
              <div className="absolute bottom-0 left-0 w-32 h-32 bg-background-alt0/10 rounded-full blur-2xl translate-y-1/2 -translate-x-1/2" />
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                <div className="flex flex-col gap-6 lg:max-w-md">
                   ...
                   <button className="w-fit px-8 py-4 bg-background text-foreground text-[13px] font-bold uppercase tracking-[0.3em] rounded-full hover:bg-stone-100 transition-all active:scale-95 shadow-lg">
                      Learn More
                   </button>
                </div>
                
                <div className="grid grid-cols-2 gap-4 w-full lg:w-auto">
                   <div className="bg-background/5 backdrop-blur-sm border border-white/10 p-6 rounded-2xl flex flex-col gap-2">
