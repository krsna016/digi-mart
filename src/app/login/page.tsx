      ...
      <main className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="w-full max-w-[420px] animate-fade-up">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-stone-500">Enter your details to sign in</p>
          </div>
          ...
          <div className="bg-background p-8 lg:p-10 rounded-[2.5rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.06)] border border-stone-200">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center ml-1">
                    <label htmlFor="password" className="text-[9px] font-bold uppercase tracking-[0.2em] text-stone-500">Password</label>
                    <Link href="/forgot-password" title="Forgot Password" className="text-[9px] font-bold uppercase tracking-[0.2em] text-foreground hover:opacity-60 transition-opacity">Forgot?</Link>
                  </div>
                  <div className="relative group">
            ...
            <div className="mt-8 pt-8 border-t border-stone-50 text-center">
              <p className="text-[11px] font-medium text-stone-500">
                ...
                <Link href="/signup" className="text-foreground font-bold uppercase tracking-widest hover:underline underline-offset-4 decoration-stone-200">
                  Create Account
                </Link>
              </p>
            </div>
