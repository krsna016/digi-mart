    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1 pt-32 pb-24">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-serif text-stone-900 mb-12 tracking-tight">Privacy Policy</h1>
          
          <div className="prose prose-stone max-w-none space-y-12">
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-stone-900 mb-4">1. Data Usage</h2>
            ...
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-stone-900 mb-4">2. User Rights</h2>
              <p className="text-stone-700 leading-relaxed font-normal">
            ...
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-stone-900 mb-4">3. Security</h2>
              <p className="text-stone-700 leading-relaxed font-normal">
            ...
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-stone-900 mb-4">4. Cookies</h2>
              <p className="text-stone-700 leading-relaxed font-normal">
