    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1 pt-32 pb-24">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-serif text-foreground mb-12 tracking-tight">Terms &amp; Conditions</h1>
          
          <div className="prose prose-stone max-w-none space-y-12">
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-foreground mb-4">1. Terms of Service</h2>
            ...
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-foreground mb-4">2. Intellectual Property</h2>
              <p className="text-stone-700 leading-relaxed font-normal">
            ...
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-foreground mb-4">3. Limitation of Liability</h2>
              <p className="text-stone-700 leading-relaxed font-normal">
            ...
            <section>
              <h2 className="text-sm font-bold uppercase tracking-[0.1em] text-foreground mb-4">4. Governing Law</h2>
              <p className="text-stone-700 leading-relaxed font-normal">
