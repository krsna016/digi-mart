...
export default function FullWidthBanner() {
  return (
    <section className="relative w-full h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden rounded-[2.5rem] shadow-premium border border-stone-200/20">
      ...
      <div className="relative z-10 text-center px-6">
        <span className="block text-[12px] font-bold uppercase tracking-[0.4em] text-stone-200 mb-6 drop-shadow-sm">Elevate Your Wardrobe</span>
