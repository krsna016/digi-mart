...
export default function LookbookSection() {
  return (
    <section className="w-full bg-[#F2F0E9] py-8 rounded-lg">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div className="md:col-span-5 relative group overflow-hidden rounded-lg bg-stone-200 aspect-[3/4]">
            <img 
          ...
          <div className="md:col-span-7 grid grid-rows-2 gap-6 lg:gap-8 h-full">
            ...
            <div className="relative group overflow-hidden rounded-lg bg-stone-200 aspect-video md:aspect-auto">
              <img 
            ...
            <div className="grid grid-cols-2 gap-6 lg:gap-8">
              <div className="relative group overflow-hidden rounded-lg bg-stone-200 aspect-[4/5] md:aspect-auto">
                <img 
              ...
              <div className="flex flex-col justify-center items-start p-6 lg:p-10 rounded-lg bg-white">
